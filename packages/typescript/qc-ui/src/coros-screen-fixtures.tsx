...
function CorOsCaptureFixture({ view }: { view: CaptureFixtureView }) {
  ...
  return <section className="qc-screen coros-capture-fixture" aria-label={view.replaceAll("-", " ")}>
    ...
    {view === "capture-intro" ? <main className="capture-intro">
      ...
      {view === "capture-routing" && <><h1>Connect your equipment</h1><p>Follow the signal path below, then confirm that all cables are connected.</p><div className="capture-routing-map"><span><b>QC SEND 1</b><i>OUT</i></span><em>→</em><span className="capture-gear"><b>AMPLIFIER</b><i>INPUT</i></span><em>→</em><span className="capture-gear"><b>CAB / LOAD</b><i>OUTPUT</i></span><em>→</em><span><b>QC RETURN 1</b><i>IN</i></span></div><div className="capture-check"><i><QcUiIcon kind="check" /></i><span><strong>Connections complete</strong><small>Use a load box when capturing an amplifier without a cabinet.</small></span></div></>}
