...
function captureTypeSnapshot(base: PresetSnapshot): PresetSnapshot {
  return {
    ...
    dirty: false,
    blocks: [{ id: "capture-type", name: "Neural Capture", kind: "capture", category: "Neural Capture", glyph: "capture-wave", row: 0, column: 0 }],
    routes: [
