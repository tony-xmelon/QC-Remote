...
export const QC_STORED_PRESET_NAME_CHARACTERS = ${limits.storedPresetNameCharacters};
...
STORED_PRESET_NAME_CHARACTERS = ${limits.storedPresetNameCharacters}
...
pub const STORED_PRESET_NAME_CHARACTERS: usize = ${limits.storedPresetNameCharacters};
...
final class QcDomain {
    ...
    static final int STORED_PRESET_NAME_CHARACTERS = ${limits.storedPresetNameCharacters};
