...
GATEWAY_ARGUMENTS = {
    ...
    "device.setTunerMeter": (frozenset(("enabled", "confirmTunerActivation")), frozenset(("enabled", "confirmTunerActivation"))),
    ...
    "device.setGlobalTempo": (frozenset(("bpm", "expectedMode", "expectedGlobalBpm")), frozenset(("bpm", "expectedMode", "expectedGlobalBpm"))),
    ...
    "device.duplicateSetlist": (frozenset(("sourceSetlistKey", "destinationName", "limit", "expectedPresetName", "expectedPosition")), frozenset(("sourceSetlistKey", "destinationName", "limit", "expectedPosition"))),
    ...
    "device.diagnostics": (frozenset(()), frozenset(())),
    "device.graphicsTree": (frozenset(()), frozenset(())),
    "device.tapScreen": (frozenset(("x", "y")), frozenset(("x", "y"))),
    "device.swipeScreen": (frozenset(("x", "y", "toX", "toY")), frozenset(("x", "y", "toX", "toY"))),
...
GATEWAY_ARGUMENT_TYPES = {
    ...
    "device.setTunerMeter": {"enabled": "boolean", "confirmTunerActivation": "boolean"},
    ...
    "device.setGlobalTempo": {"bpm": "integer", "expectedMode": "string", "expectedGlobalBpm": "integer"},
    "device.looperStatus": {},
    ...
    "device.swipeScreen": {"x": "integer", "y": "integer", "toX": "integer", "toY": "integer"},
...
def dispatch_device_method(device, method, params):
    ...
    elif method == "device.setTunerMeter":
        return device.set_tuner_meter(params.get("enabled"), params.get("confirmTunerActivation"))
    ...
    elif method == "device.setGlobalTempo":
        return device.set_global_tempo(params.get("bpm"), params.get("expectedMode"), params.get("expectedGlobalBpm"))
    ...
    elif method == "device.duplicateSetlist":
        return device.duplicate_setlist(params.get("sourceSetlistKey"), params.get("destinationName"), params.get("limit"), params.get("expectedPresetName", ""), params.get("expectedPosition"))
    ...
    elif method == "device.diagnostics":
        return device.diagnostics()
    elif method == "device.graphicsTree":
        return device.graphics_tree()
    elif method == "device.tapScreen":
        return device.tap_screen(params.get("x"), params.get("y"))
    elif method == "device.swipeScreen":
        return device.swipe_screen(params.get("x"), params.get("y"), params.get("toX"), params.get("toY"))
